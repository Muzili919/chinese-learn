...
export const KNOWLEDGE_DEPS = {
  ...
  '英语词汇': { roots: [], suggests: '词汇星球 → 单词记忆' },
  '英语听力': { roots: ['英语词汇'], suggests: '听力星球 → 听力训练' },
  '英语语法': { roots: ['英语词汇'], suggests: '语法星球 → 语法练习' },
  '英语阅读': { roots: ['英语词汇', '英语语法'], suggests: '阅读星球 → 阅读理解' },
  '英语写作': { roots: ['英语词汇', '英语语法'], suggests: '写作星球 → 作文练习' },
  '英语联想': { roots: ['英语词汇'], suggests: '词汇星球 → 联想记忆' },
  '英语综合': { roots: ['英语词汇', '英语语法'], suggests: '综合练习 → 全科训练' },
  '词汇辨析': { roots: ['英语词汇'], suggests: '词汇星球 → 近义词辨析' },
  '应用文写作': { roots: ['英语词汇', '英语语法'], suggests: '写作星球 → 应用文专项' },
  '话题写作': { roots: ['英语词汇', '英语语法'], suggests: '写作星球 → 话题练习' },
  '综合': { roots: [], suggests: '全科综合练习' },

  // ── 道法 ──
  '选择题': { roots: [], suggests: '选择题专项 → 基础知识巩固' },
  ...
  '分数运算': { roots: [], suggests: '数学星球 → 数与运算' },
  '平面图形': { roots: [], suggests: '数学星球 → 图形与空间' },
  '行程问题': { roots: ['分数运算'], suggests: '数学星球 → 奥数专题' },
  '公式速记': { roots: [], suggests: '公式速记 → 公式记忆' },
  '等式性质': { roots: ['数与代数'], suggests: '数学星球 → 方程与不等式' },
  '平面直角坐标系': { roots: ['方程与不等式'], suggests: '数学星球 → 函数与图像' },
  '整式加减': { roots: ['数与代数'], suggests: '数学星球 → 整式运算' },
  '相交线与平行线': { roots: ['图形与几何'], suggests: '数学星球 → 几何证明' },
  '分数加法': { roots: ['分数运算'], suggests: '数学星球 → 数与运算' },
  '面积公式': { roots: ['平面图形'], suggests: '公式速记 → 面积公式' },
  '三角形面积': { roots: ['平面图形'], suggests: '数学星球 → 图形与空间' },
  '用字母表示数': { roots: ['数与代数'], suggests: '数学星球 → 整式运算' },
  '盈亏问题': { roots: ['分数运算'], suggests: '数学星球 → 奥数专题' },
}
